<template>
  <div>
    ...
    <a-modal
        ...
        :title="'图片裁剪'"
        :width="'40%'"
        modal-class="admin_cropper_upload_dialog"
        body-class="admin_cropper_modal"
      ...
      <div class="cropper">
        <div class="cropper_left">
          ...
          <div class="re_upload_box">
            <div class="re_upload_text" @click="uploadFile('reload')">
              重新上传
            </div>
            <div>
...
// input组件Ref
const re_uploadInput = ref<HTMLElement | null | undefined>()
// 回显图片使用的方法
